...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=attendance" class="nav-item nav-attendance"><span class='icon-field'><i class="fa fa-user-friends"></i></span> Check in</a>
				<?php endif; ?>
				<a href="index.php?page=chatforum" class="nav-item nav-chat"><span class='icon-field'><i class="fa fa-user-friends"></i></span> Chat</a>
				<?php if($_SESSION['login_type'] == 1): ?>
				...
				<a href="index.php?page=report" class="nav-item nav-report"><span class='icon-field'><i class="fa fa-user-friends"></i></span> Attendance report</a>
			<?php endif; ?>
