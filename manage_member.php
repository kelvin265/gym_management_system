...
<div class="container-fluid">
	<form action="" id="manage-member">
		...
		<input type="hidden" name="plan_id" value="" class="form-control">
		<input type="hidden" name="package_id" value="" class="form-control">
		<input type="hidden" name="trainer_id" value="" class="form-control">
	</form>
</div>
